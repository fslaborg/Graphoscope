...
type Graphs () =
    ...
    member this.GlobalSetupData() =
        ...
        for i=0 to this.NumberEdges-1 do
            let (node1,node2,data) = edgesArr.[i]
            DiGraph.addEdge (node1, node2, data) gDi|> ignore
        diGraph <- gDi
        //prepare DiNodeGraph
        ...
        for i=0 to this.NumberEdges-1 do
            let (node1,node2,data) = edgesArr.[i]
            UndirectedGraph.addEdge (node1, node2, data) gDiNo|> ignore
        diNodeGraph <- gDiNo
        //prepare FGraph
    ...
    member this.Access_UndirectedGraph () =  
       ...
       for i=0 to this.NumberEdges-1 do
           let (node1,node2,_) = edgesArr.[i]
           let _,_,d = UndirectedGraph.find node1 node2 diNodeGraph
           yield d
       |] 
...
// //  Graphs.FGraph: Default        -> It seems that the distribution is bimodal (mValue = 4)
...
// //  Graphs.Access_FGraph: Default -> It seems that the distribution is bimodal (mValue = 3.22)

// //// * Hints *
// //Outliers
// //  Graphs.AdjGraph: Default      -> 1 outlier  was  removed (39.24 us)
// //  Graphs.AdjComp: Default       -> 2 outliers were removed (40.00 us, 41.82 us)
// //  Graphs.DiGraph: Default       -> 1 outlier  was  removed (16.39 us)
// //  Graphs.FGraph: Default        -> 3 outliers were removed (44.57 us..47.00 us)
...
// //  Graphs.Access_FGraph: Default -> 2 outliers were removed (19.29 us, 23.24 us)
// //  Graphs.AdjGraph: Default      -> 2 outliers were detected (2.92 ms, 2.94 ms)
// //  Graphs.AdjComp: Default       -> 1 outlier  was  removed (3.98 ms)
// //  Graphs.DiGraph: Default       -> 1 outlier  was  removed, 2 outliers were detected (1.77 ms, 1.91 ms)
// //  Graphs.FGraph: Default        -> 1 outlier  was  removed (3.50 ms)
...
// //  Graphs.Access_FGraph: Default -> 4 outliers were detected (2.59 ms..3.07 ms)
...
// //  Graphs.DiGraph: Default       -> 2 outliers were detected (1.79 ms, 2.01 ms)
// //  Graphs.FGraph: Default        -> 1 outlier  was  detected (4.17 ms)
...
// //  Graphs.Access_FGraph: Default -> 1 outlier  was  removed (15.78 us)
// //  Graphs.DiGraph: Default       -> 1 outlier  was  removed, 2 outliers were detected (9.71 ms, 13.58 ms)
...
// //  Graphs.Access_FGraph: Default -> 3 outliers were removed (6.66 ms..6.94 ms)
