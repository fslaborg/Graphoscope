...
let ofArrayAdjacencyGraph (startingGraph: ArrayAdjacencyGraph<'Vertex,'Label,'Edge>) (numberOfVertices: int) (numberOfEdgesPerIteration: int) (fVertexKey: int -> 'Vertex) (fLabel: 'Vertex -> 'Label) (fWeight: 'Vertex*'Vertex -> 'Edge) =
